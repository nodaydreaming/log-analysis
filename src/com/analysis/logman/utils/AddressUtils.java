            ...
            for(int i = 2;i <= 6;i++){
                switch (i){
                    case 2:
                        ...
                        if(!country.equals("")&&!country.equals("XX")&&!country.equals("内网IP"))
                            address.append(country);
                        break;
//                    case 3:
//                        area = (temp[i].split(":"))[1].replaceAll("\"", "");
//                        area = decodeUnicode(area);// 地区
//                        if(!area.equals("")&&!area.equals("XX")&&!area.equals("内网IP"))
//                            address.append(area);
//                        break;
//                    case 4:
//                        region = (temp[i].split(":"))[1].replaceAll("\"", "");
//                        region = decodeUnicode(region);// 省份
//                        if(!region.equals("")&&!region.equals("XX")&&!region.equals("内网IP"))
//                            address.append(region);
//                        break;
                    case 5:
                        city = (temp[i].split(":"))[1].replaceAll("\"", "");
                        city = decodeUnicode(city);// 城市
                        if(!city.equals("")&&!city.equals("XX")&&!city.equals("内网IP"))
                            address.append(city);
                        break;
//                    case 6:
//                        county = (temp[i].split(":"))[1].replaceAll("\"", "");
//                        county = decodeUnicode(county);
//                        if(!county.equals("")&&!county.equals("XX")&&!county.equals("内网IP"))
